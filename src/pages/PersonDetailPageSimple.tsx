  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-8">
                <div className="aspect-[2/3] rounded-lg overflow-hidden bg-gray-800 mb-6 profile-image-container">
                  <img
                ...
                <div className="animate-fadeInUp animate-delay-400">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                    {profileImages.map((image, index) => (
                      <button
                        key={index}
                        className="aspect-[2/3] rounded-lg overflow-hidden bg-gray-800 cursor-pointer hover:ring-2 hover:ring-purple-400 photo-gallery-item"
      ...
      {sortedMovieCredits.length > 0 && (
        <section className="px-4 sm:px-6 lg:px-8 py-8 animate-fadeInUp animate-delay-600">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="overflow-x-auto pb-4">
              <div className="flex gap-6 horizontal-scroll-container">
