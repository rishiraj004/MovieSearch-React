...
export function SearchBar() {
  ...
  return (
    <>
      ...
      {isMobileSearchOpen && (
        <div className="md:hidden fixed inset-0 z-50 bg-gray-900/95 backdrop-blur-md p-3 sm:p-4">
      ...
      <div className="fixed top-3 right-3 sm:top-4 sm:right-4 z-30">
        ...
        <button
          ...
          className="md:hidden bg-black/40 backdrop-blur-md rounded-lg p-2.5 sm:p-3 text-white/80 hover:text-white transition-colors border border-white/10 cursor-pointer"
        >
